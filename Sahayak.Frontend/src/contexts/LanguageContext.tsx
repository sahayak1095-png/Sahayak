...
const translations: Record<string, { en: string; kn: string }> = {
  ...
  'home.servicesLabel': { en: '329 services · 20 categories · Bengaluru', kn: '329 ಸೇವೆಗಳು · 20 ವರ್ಗಗಳು · ಬೆಂಗಳೂರು' },
  ...
  'services.subheading': { en: 'Search for a service, choose a category, and book trusted help near you.', kn: 'ಸೇವೆಯನ್ನು ಹುಡುಕಿ, ವರ್ಗವನ್ನು ಆಯ್ಕೆಮಾಡಿ, ನಿಮ್ಮ ಹತ್ತಿರ ವಿಶ್ವಾಸಾರ್ಹ ಸಹಾಯವನ್ನು ಬುಕ್ ಮಾಡಿ.' },
  ...
  'confirm.fee': { en: 'Only a service fee will be charged — no hidden fees, no extra markups.', kn: 'ಮಾತ್ರ ಸೇವಾ ಶುಲ್ಕವೇ ವಿಧಿಸಲಾಗಿದೆ — ಏನೂ ಮರುಗಲಿಸುವ ಶುಲ್ಕವಿಲ್ಲ, ಹೆಚ್ಚುವರಿ ಮಾರ್ಕಪ್ ಇಲ್ಲ.' },
